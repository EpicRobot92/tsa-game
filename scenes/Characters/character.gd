...
enum State {IDLE, WALK, ATTACK, TAKEOFF, JUMP, LAND, JUMPKICK, HURT, FALL, GROUNDED, DEATH, FLY, PREP_ATTACK, SWAP}
enum Type {PLAYER, BASIC_ENEMY, DASH_ENEMY, ELITE_DASHER_ENEMY, EVANGELINE, EDEN, ANGELICA}
